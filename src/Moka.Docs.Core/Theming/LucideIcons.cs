...
public static class LucideIcons
{
    private static readonly Dictionary<string, string> Icons = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["nuget"] = Svg(
            "<path d='M6.5 17.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z'/><path d='M14 14a4 4 0 1 0 0-8 4 4 0 0 0 0 8z'/><circle cx='7' cy='7' r='2'/>"),
        ["discord"] = Svg(
    ...
    {
        return Icons.GetValueOrDefault(name.ToLowerInvariant());
    }
