...
public sealed class SiteConfigReaderTests
{
    ...
    public void Parse_MinimalConfig_ReturnsConfigWithDefaults()
    {
        ...
        var config = SiteConfigReader.Parse(yaml);
    ...
    public void Parse_MissingSiteSection_Throws()
    {
        ...
        var act = () => SiteConfigReader.Parse(yaml);
    ...
    {
        var act = () => SiteConfigReader.Parse("");
    ...
    public void ToYaml_RoundTrip_PreservesValues()
    {
        ...
        var config = SiteConfigReader.Parse(yaml);
        var serialized = SiteConfigReader.ToYaml(config);
        var reparsed = SiteConfigReader.Parse(serialized);
