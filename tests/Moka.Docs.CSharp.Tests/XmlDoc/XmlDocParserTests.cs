...
public sealed class XmlDocParserTests
{
    ...
    public void ParseXml_MethodWithParams_ExtractsAll()
    {
        ...
        var result = _parser.ParseXml(xml);
        var doc = result.Members["M:MyApp.Calculator.Add(System.Int32,System.Int32)"];
    ...
    public void ParseXml_InlineElements_RenderedCorrectly()
    {
        ...
        var result = _parser.ParseXml(xml);
        var doc = result.Members["M:MyApp.Foo.Bar"];
    ...
    public void ParseXml_ParamrefAndTypeparamref_Rendered()
    {
        ...
        var result = _parser.ParseXml(xml);
        var doc = result.Members["M:MyApp.Foo.Process``1(``0)"];
    ...
    {
        var result = _parser.ParseXml("<doc><assembly><name>Empty</name></assembly><members/></doc>");
    ...
    {
        var result = _parser.ParseXml("not xml at all");
    ...
    public void ParseXml_ListElement_RenderedAsList()
    {
        ...
        var result = _parser.ParseXml(xml);
        var doc = result.Members["T:MyApp.Foo"];
