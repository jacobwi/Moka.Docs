...
public sealed class TocGeneratorTests
{
    ...
    private MarkdownDocument ParseDoc(string md)
    {
    ...
    {
        var doc = ParseDoc("## One\n## Two\n## Three");

        var toc = _generator.Generate(doc);
    ...
    {
        var doc = ParseDoc("Just a paragraph.\n\nAnother paragraph.");
    ...
    {
        var doc = ParseDoc("## Getting Started\n## API Reference (v2)\n## What's New?");
    ...
    public void Generate_FallsBackToGenerateAnchorId_WhenNoAttributes()
    {
        ...
        var doc = Markdig.Markdown.Parse("## Hello World", plainPipeline);
